...
export function NutritionLabel({ isOpen, onClose, food, onEdit, onDelete }) {
  ...
  useEffect(() => {
    ...
    if (food?.servings) {
      ...
      const gramBasedServing = servingsList.find(s => 
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent hideClose={true} className="max-w-md dark:bg-zinc-800">
        <DialogHeader>
          ...
          <DialogDescription className="dark:text-gray-300 text-lg font-bold">
            {food?.food_name}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="border-b-2 border-gray-700 py-2">
          <div className="text-xl font-bold dark:text-white">
            Calories {calculateNutrition(selectedServing?.calories || food.calories || 0)}
          </div>
        </div>
        ...
        <div className="space-y-1 text-sm border-b border-gray-700 py-2">
          ...
          <div className="flex justify-between pl-4 dark:text-gray-300">
            ...
            <span>{calculateNutrition(selectedServing?.saturated_fat || 0)}g</span>
          </div>
          <div className="flex justify-between pl-4 dark:text-gray-300">
            <span>Trans Fat</span>
          ...
          <div className="flex justify-between pl-4 dark:text-gray-300">
            ...
            <span>{calculateNutrition(selectedServing?.polyunsaturated_fat || 0)}g</span>
          </div>
          <div className="flex justify-between pl-4 dark:text-gray-300">
            <span>Monounsaturated Fat</span>
            <span>{calculateNutrition(selectedServing?.monounsaturated_fat || 0)}g</span>
          </div>

          <div className="flex justify-between font-bold dark:text-white pt-1">
            <span>Cholesterol</span>
            <span>{calculateNutrition(selectedServing?.cholesterol || 0)}mg</span>
          </div>
          <div className="flex justify-between font-bold dark:text-white">
            <span>Sodium</span>
          ...
          <div className="flex justify-between pl-8 dark:text-gray-300">
            ...
            <span>{calculateNutrition(selectedServing?.added_sugar || 0)}g</span>
          </div>
        ...
        <div className="space-y-1 text-sm py-2">
          <div className="flex justify-between dark:text-gray-300">
            <span>Vitamin D</span>
            <span>{calculateNutrition(selectedServing?.vitamin_d || 0)}mcg</span>
          </div>
          <div className="flex justify-between dark:text-gray-300">
            <span>Calcium</span>
          ...
          <div className="flex justify-between dark:text-gray-300">
            <span>Vitamin A</span>
            <span>{calculateNutrition(selectedServing?.vitamin_a || 0)}mcg</span>
          </div>
          <div className="flex justify-between dark:text-gray-300">
            <span>Vitamin C</span>
